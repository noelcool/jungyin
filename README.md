...
# 👏 Work Experience
## 어드민(2022년 1월 ~ 2022년 6월)
  - Java8, SpringBoot, JPA, MyBatis, MariaDB, MySQL, Thymeleaf
  - 어플리케이션 관리자를 위한 어드민 시스템
  - 회원 관리, 회원 문의 답변
  - 수집한 데이터 관리 및 업데이트
  - 카드 정보 추가 및 수정
## API 고도화(2022년 1월 ~ 2022년 6월)
...
- 펀드 이름(ex : 피델리티 재팬 증권 투자신탁) 정규화 및 검색, 유지보수
## 카드 추천 시스템(2021년 5월 ~ 2021.12월)
- Java, SpringBoot, JPA, MyBatis, MariaDB
- 사용자의 소비 내역 대비 최고의 혜택을 줄 수 있는 카드 추천
- 새로 추가된 카드 검색 및 카드 관련 정보 제공

## 소비 내역 기반 카드 추천 분석 시스템 (2018년 10월 ~ 2020년 10월)
- Python, Flask, SqlAlchemy
- 사용자의 소비 내역을 분석해서 혜택을 찾아주는 알고리즘 개발
- 사용자의 소비 내역 50개를 존재하는 모든 카드와 매칭해서 최고의 매칭 카드를 찾기
...
-  기존의 API가 비동기를 고려하지 않기 때문에 몇천개의 상품을 가지고 있는 경우 속도가 지나치게 느려지는 케이스가 발생하여 비동기를 지원하도록 프로젝트 재구성
...
## 네트워크 인프라 운영(2018년 6월 ~ 2022년 6월)
- 전체 운영 서버 관리
- TLS, MTLS 인증서 설치
- 리눅스 보안 취약점 점검
- 배포 지원 및 설정

## API (2018년 6월 ~ 2021년 12월)
